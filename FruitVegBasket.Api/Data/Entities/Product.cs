...
namespace FruitVegBasket.Api.Data.Entities
{
    ...
    public class Product
    {
        ...
        public static IEnumerable<Product> GetInitialData()
        {
            ...
            {
                new(1, "Chicken Breast", null, 4.99m, "per pound", 13), 
                new(2, "Pork Chops", null, 6.99m, "per pound", 13), 
                new(3, "Salmon", null, 9.99m, "per pound", 14), 
                new(4, "Shrimp", null, 12.99m, "per pound", 14), 
                new(5, "Chicken Thighs", null, 3.99m, "per pound", 13), 
                new(6, "Ground Turkey", null, 4.99m, "per pound", 13), 
                new(7, "Lamb Chops", null, 10.99m, "per pound", 13), 
                new(8, "Tuna", null, 8.99m, "per pound", 14), 
                new(9, "Pork Ribs", null, 7.99m, "per pound", 13), 
                new(10, "Cod", null, 10.99m, "per pound", 14), 
                new(11, "Chicken Wings", null, 3.99m, "per pound", 13), 
                new(12, "Ground Pork", null, 4.99m, "per pound", 13), 
                new(13, "Tilapia", null, 7.99m, "per pound", 14), 
                new(14, "Chicken Drumsticks", null, 2.99m, "per pound", 13), 
                new(15, "Turkey Breast", null, 5.99m, "per pound", 13), 
                new(16, "Catfish", null, 9.99m, "per pound", 14), 
                new(17, "Scallops", null, 15.99m, "per pound", 14), 
                new(18, "Turkey Bacon", null, 4.99m, "per pack", 13),
                new(19, "Ground Chicken", null, 4.99m, "per pound", 13), 
                new(20, "Salmon Fillet", null, 12.99m, "per pound", 14), 
                new(21, "Pork Sausage", null, 5.99m, "per pack", 13)
            };
